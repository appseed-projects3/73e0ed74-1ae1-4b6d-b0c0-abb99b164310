...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-22 20:29`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/73e0ed74-1ae1-4b6d-b0c0-abb99b164310.git
$ cd 73e0ed74-1ae1-4b6d-b0c0-abb99b164310
```
